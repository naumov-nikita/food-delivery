...
initialLocalSet('#gender div', 'calculating__choose-item_active');
initialLocalSet('.calculating__choose_big div', 'calculating__choose-item_active');

function initialLocalSet(selector, activeClass) {
...
document.addEventListener('DOMContentLoaded', () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer', "2021-11-24");
